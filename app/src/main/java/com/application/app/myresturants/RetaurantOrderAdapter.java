...
import com.application.app.myresturants.dialog.OrderStatusRestaurantFragmnet;
...
public class RetaurantOrderAdapter extends RecyclerView.Adapter<RetaurantOrderAdapter.ViewHolder>{
    private ArrayList<OrdersModel> listdata;
    FragmentActivity context;
    // RecyclerView recyclerView;
    public RetaurantOrderAdapter(ArrayList<OrdersModel> listdata, FragmentActivity activity) {
            ...
            public void onClick(View view) {
              //  OrderStatusFragmnet.newInstance(position+1,myListData);
                ...
                FragmentManager fm = activity.getSupportFragmentManager();
                    OrderStatusRestaurantFragmnet alertDialog = new OrderStatusRestaurantFragmnet().newInstance(1,myListData);
